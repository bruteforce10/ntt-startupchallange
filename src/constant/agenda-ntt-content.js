...
export const SCHEDULE_DATA = [
  ...
  // {
  //   time: "13:00-13:10",
  //   content: "Opening Remark/About Startup Challenge",
  //   presenter: "Ken Katsuyama (SVP, Head of Global Business, NTT Holdings)",
  //   isHighlighted: false,
  //   isBreak: false,
  // },
  // {
  //   time: "13:10-13:20",
  //   content: "Keynote 1",
  //   presenter: "Theodore Sutarto (Indonesia Government)",
  //   isHighlighted: false,
  //   isBreak: false,
  // },
  // {
  //   time: "13:20-13:30",
  //   content: "Keynote 2",
  //   presenter: "Akiye Iriyama (Professor at Waseda University)",
  //   isHighlighted: false,
  //   isBreak: false,
  // },
  // {
  //   time: "13:30-14:20",
  //   content: "Startup Pitch 1 (5min/Q&A 3 min/Transition 2 min) x 5 Startups",
  //   presenter: "Top 10 Finalist",
  //   isHighlighted: true,
  //   isBreak: false,
  // },
  // {
  ...
  //   presenter: "SEA VC, Startup Founder etc.",
  //   isHighlighted: false,
  //   isBreak: false,
  // },
  // {
  //   time: "15:00-16:00",
  //   content: "Startup Pitch 2 (5min/Q&A 3 min/Transition 2 min) x 6 Startups",
  //   presenter: "Top 10 Finalists",
  //   isHighlighted: true,
  //   isBreak: false,
  // },
  // {
  //   time: "16:00-16:20",
  //   content: "Presentation by CVC/NTT Opco",
  //   presenter:
  //     "Makiko Yamada (NTT Holdings), Akiko Hirao (NTT Docomo Ventures)",
  //   isHighlighted: false,
  //   isBreak: false,
  // },
  // {
  ...
  //   time: "16:40-17:10",
  //   content: "Award",
  //   presenter: "Yasuhiro Kajiki (President Director, PT. NTT Indonesia)",
  //   isHighlighted: false,
  //   isBreak: false,
  // },
  // {
  //   time: "17:10-17:20",
  //   content: "Close Remarks",
  //   presenter: "Yasuhiro Nishino (Manager NTT Holdings)",
  //   isHighlighted: false,
  //   isBreak: false,
  // },
  // {
  ...
  //   presenter: "Top 10 Finalist and more",
  //   isHighlighted: true,
  //   isBreak: false,
  // },
];
